...
rand_12 = np.random.randint(low=0, high=101, size=(12))
print(rand_12)

# Create an 3x4 (3 rows x 4 columns).
my_data = np.array([[rand_12[0], rand_12[1], rand_12[2], rand_12[3]], [rand_12[4], rand_12[5], rand_12[6], rand_12[7]], [rand_12[8], rand_12[9], rand_12[10], rand_12[11]]])
print(my_data)
...
# columns are named Eleanor, Chidi, Tahani, and Jason
